...
QT_MOC_LITERAL(1, 18, 22), // "on_Good_preview_clicke"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 7) // "good_id"

    },
    "GoodPreviewWidget\0on_Good_preview_clicke\0"
    "\0good_id"
};
...
void GoodPreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_Good_preview_clicke((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GoodPreviewWidget::on_Good_preview_clicke)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GoodPreviewWidget::on_Good_preview_clicke(const QString & _t1)
{
