    ...
    ui(new Ui::CommentListWidgetItem)
{
    ...
    else
    {
       ...
       this->ui->txt_description->setAlignment(Qt::AlignRight);
       this->ui->lab_adv_content->setAlignment(Qt::AlignRight);
       this->ui->lab_disadv_content->setAlignment(Qt::AlignRight);
